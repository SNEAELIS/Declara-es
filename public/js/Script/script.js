...
async function generateAllDeclarationsPDF() {
    ...
    const rgDirigente = document.getElementById('rgDirigente').value;
    const orgaoExpedidorDirigente = document.getElementById('orgaoExpedidorDirigente').value;
    ...
    var docDefinition = {
        ...
        content: [
            ...
            {
                text: [
                    `Eu, ${dirigente}, portador da carteira de identidade nº ${rgDirigente}, expedida pelo ${orgaoExpedidorDirigente}, CPF nº ${cpf}, na condição de representante legal da ${entidade}, CNPJ nº ${cnpj}, declaro para os devidos fins de celebração de Termo de Fomento no âmbito do Ministério do Esporte - MESP, que a presente Entidade, não utilizará os recursos para finalidade alheia ao objeto da parceria.\n\n`,
            ...
            {
                text: [
                    `Eu, ${dirigente}, portador da carteira de identidade nº ${rgDirigente}, expedida pelo ${orgaoExpedidorDirigente}, CPF nº ${cpf}, na condição de representante legal da ${entidade}, CNPJ nº ${cnpj}, declaro para os devidos fins, que a presente Entidade, cumprirá com o disposto no art. 89, incisos IV e VIII, da Lei nº 15.080, de 30 de dezembro de 2024:\n\n`,
            ...
            {
                text: [
                    `A ${entidade}, pessoa jurídica de direito privado, na forma de associação sem fins lucrativos, com sede na ${endereco}, inscrita no CNPJ nº ${cnpj}, neste ato representada por ${dirigente}, brasileiro, ${cargoDirigente}, RG ${rgDirigente}, declara para fins de cadastramento de celebração do presente Termo de Fomento junto ao Ministério do Esporte - MESP, que a ${entidade}, é uma entidade viável e autônoma financeiramente, e que, de acordo com as demonstrações contábeis regularmente escrituradas, sob pena do art. 299 do Código Penal:\n\n`,
            ...
            {
                text: [
                    `Eu, ${dirigente}, portador da carteira de identidade nº ${rgDirigente}, expedida pelo ${orgaoExpedidorDirigente}, CPF nº ${cpf}, na condição de representante legal da ${entidade}, CNPJ nº ${cnpj}, DECLARO para os devidos fins, nos termos do art. 26, caput, inciso IX, do Decreto nº 8.726, de 2016, que a presente Entidade e seus dirigentes não incorrem em quaisquer das vedações previstas no art. 39 da Lei nº 13.019, de 2014. Nesse sentido:\n\n`,
            ...
            {
                text: [
                    `Eu, ${dirigente}, portador da carteira de identidade nº ${rgDirigente}, expedida pelo ${orgaoExpedidorDirigente}, CPF nº ${cpf}, na condição de representante legal da ${entidade}, CNPJ nº ${cnpj}, ATESTO que a presente entidade, existe há, no mínimo, 3 (três) anos e possui o cadastro ativo, bem como experiência prévia na realização, com efetividade, no desenvolvimento de Projetos e/ou Eventos de objeto de natureza semelhante, assim como, instalações, condições materiais e capacidade técnica e operacional para o desenvolvimento do objeto apresentado na Proposta nº ${proposta}/2024 e para o cumprimento das metas estabelecidas, em atendimento aos dispostos no art. 89, inciso XI, da Lei nº 15.080/2024 (LDO 2025), no art. 33, inciso V, da Lei nº 13.019/2014 e no art. 26, incisos I, II e III, do Decreto nº 8.726/2016 ou outras condições materiais para contratar ou adquirir com recursos da parceria, em conformidade com o art. 26, inciso X, do Decreto nº 8.726/2016.\n\n`
                ],
                alignment: 'justify',
                fontSize: 12,
                margin: [0, 20, 0, 40]
            ...
            {
                text: [
                    `Eu, ${dirigente}, portador da carteira de identidade nº ${rgDirigente}, expedida pelo ${orgaoExpedidorDirigente}, CPF nº ${cpf}, na condição de representante legal do(a) ${entidade}, CNPJ nº ${cnpj}, declaro o compromisso de:\n\n`,
            ...
            {
                text: [
                    `Eu, ${dirigente}, portador da carteira de identidade nº ${rgDirigente}, expedida pelo ${orgaoExpedidorDirigente}, CPF nº ${cpf}, na qualidade de representante legal do(a) ${entidade}, inscrito(a) no CNPJ sob o nº ${cnpj}, `,
            ...
            {
                text: [
                    `Eu, ${dirigente}, portador da carteira de identidade nº ${rgDirigente}, expedida pelo ${orgaoExpedidorDirigente}, CPF nº ${cpf}, na condição de representante legal do(a) ${entidade}, inscrito(a) no CNPJ sob o nº ${cnpj}, `,
                    { text: 'DECLARO', bold: true },
...
async function generateAtestadoPDF() {
    const formData = {
        ...
        rgDirigente: document.getElementById('rgDirigente').value,
        orgaoExpedidorDirigente: document.getElementById('orgaoExpedidorDirigente').value,
...
async function generateTermoCompromissoCoordenadorPDF() {
    ...
    const orgaoExpedidorCoordenador = document.getElementById('orgaoExpedidorCoordenador').value;

    if (!coordenador || !cpfCoordenador || !rgCoordenador || !orgaoExpedidorCoordenador) {
    ...
    var docDefinition = {
        ...
        content: [
            ...
            {
                text: [
                    `Eu, ${dirigente}, CPF nº ${cpfDirigente}, na condição de representante legal do(a) ${entidade}, inscrito(a) no CNPJ sob o nº ${cnpjEntidade}, indico para a atribuição de Coordenador Geral do Programa ${nomePrograma} o servidor ${coordenador}, RG nº ${rgCoordenador}, expedido pelo ${orgaoExpedidorCoordenador}, CPF nº ${cpfCoordenador}, vinculado à esta Entidade como Coordenador Geral, possuindo a qualificação exigida para o desenvolvimento do Programa ${nomePrograma}, devidamente comprovada, com dedicação de 40 horas semanais junto ao Programa.\n\n`
                ],
                alignment: 'justify',
                fontSize: 12,
                margin: [0, 0, 0, 40]
