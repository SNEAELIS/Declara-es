...
async function generateAllDeclarationsPDF() {
    // Fixed values based on OCR and prior context
    const dirigente = "Pedro Dias";
    const cargoDirigente = "Presidente";
    const entidade = "BANCO DO BRASIL SA";
    const cnpj = "00.000.000/0001-91";
    const endereco = "SAUN QUADRA 5 BLOCO B TORRE I, ASA NORTE, BRASÍLIA/DF";
    const uf = "DF";
    const municipio = "Brasília";
    const proposta = "22222/2024";
    const date = "10/07/2025 às 22:18";
    ...
    // Lista de declarações para o sumário
    const declarations = [
    ...
    const docDefinition = {
        ...
        content: [
            ...
            {
                text: `Eu, ${dirigente}, na condição de ${cargoDirigente} da ${entidade}, CNPJ nº ${cnpj}, declaro para os devidos fins de celebração de Termo de Fomento no âmbito do Ministério do Esporte - MESP, que a presente Entidade não utilizará os recursos para finalidade alheia ao objeto da parceria.`,
                alignment: 'justify',
                fontSize: 12,
                margin: [0, 20, 0, 20],
                pageBreak: 'after'
            ...
            // Página de sumário ajustada para nova página
            {
                text: 'Sumário das Declarações Referenciais',
                style: 'header',
                alignment: 'center',
                margin: [0, 20, 0, 5]
            },
            ...
            {
                text: `Por ser verdade, firmo o teor das declarações referenciais que compõem este arquivo.`,
                alignment: 'center',
                fontSize: 11,
                margin: [0, 10, 0, 10]
            },
            {
                text: `${municipio.toUpperCase()}/${uf.toUpperCase()}, ${date}.`,
                alignment: 'center',
                fontSize: 11,
                margin: [0, 10, 0, 10]
            },
