...
async function generateAllDeclarationsPDF() {
    ...
    const docDefinition = {
        ...
        content: [
            ...
            {
                text: [
                    `Eu, ${dirigente}, na condição de ${cargoDirigente} da ${entidade}, CNPJ nº ${cnpj}, ATESTO que a presente entidade existe há, no mínimo, 3 (três) anos e possui o cadastro ativo, bem como experiência prévia na realização, com efetividade, no desenvolvimento de Projetos e/ou Eventos de objeto de natureza semelhante, assim como instalações, condições materiais e capacidade técnica e operacional para o desenvolvimento do objeto apresentado na Proposta nº ${proposta}/2024 e para o cumprimento das metas estabelecidas, em atendimento aos dispostos no art. 89, inciso XI, da Lei nº 15.080/2024 (LDO 2025), no art. 33, inciso V, da Lei nº 13.019/2014 e no art. 26, incisos I, II e III, do Decreto nº 8.726/2016 ou outras condições materiais para contratar ou adquirir com recursos da parceria, em conformidade com o art. 26, inciso X, do Decreto nº 8.726/2016.\n\n`
                ],
                alignment: 'justify',
                fontSize: 12,
                margin: [0, 20, 0, 40]
